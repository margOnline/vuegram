  ...
  <div id="login">
    ...
    <section>
      <div class="col1">
        <h1>Vuegram</h1>
        <p>Welcome to the 
          <a href="https://savvyapps.com" target="_blank">Savvy Apps</a>
          social media web app powered by vue.js and Firebase. Build this project by checking out The Definitive Guide to Getting Started with vue.js.
        </p>
      </div>
      <div class="col2" :class="{ 'signup-form': !showLoginForm && !showForgotPassword }">
        ...
        <form v-if="showForgotPassword" @submit.prevent class="password-reset">
          <div v-if="passwordResetSuccess">
            ...
            <div class="extras">
              <a @click="resetPassword">Backto Log In</a>
            </div>
          </div>
          <div v-else>
            <h1>Email Sent</h1>
            <p>check your email fora link to resetyour password</p>
